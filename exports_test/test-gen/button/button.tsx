            ...
            <div className="container mx-auto px-6 py-8">
              ...
              <div className="w-full">
                <div className="space-y-8">
                  ...
                  <div className="rounded-lg border bg-slate-950 p-8 relative">
                    <div className="grid grid-cols-6 gap-4">
                      <Button variant="default" size="default" className="dark">Button</Button>
                      <Button variant="default" size="default" className="dark">Button</Button>
                      <Button variant="default" size="default" className="dark">Button</Button>
                      <Button variant="default" size="default" className="dark">Button</Button>
                      <Button variant="default" size="default" className="dark">Button</Button>
                      <Button variant="default" size="default" className="dark">Button</Button>
                      <Button variant="secondary" size="default" className="dark">Button</Button>
                      <Button variant="secondary" size="default" className="dark">Button</Button>
                      <Button variant="secondary" size="default" className="dark">Button</Button>
                      <Button variant="secondary" size="default" className="dark">Button</Button>
                      <Button variant="secondary" size="default" className="dark">Button</Button>
                      <Button variant="secondary" size="default" className="dark">Button</Button>
                      <Button variant="outline" size="default" className="dark">Button</Button>
                      <Button variant="outline" size="default" className="dark">Button</Button>
                      <Button variant="outline" size="default" className="dark">Button</Button>
                      <Button variant="outline" size="default" className="dark">Button</Button>
                      <Button variant="outline" size="default" className="dark">Button</Button>
                      <Button variant="outline" size="default" className="dark">Button</Button>
                      <Button variant="ghost" size="default" className="dark">Button</Button>
                      <Button variant="ghost" size="default" className="dark">Button</Button>
                      <Button variant="ghost" size="default" className="dark">Button</Button>
                      <Button variant="ghost" size="default" className="dark">Button</Button>
                      <Button variant="ghost" size="default" className="dark">Button</Button>
                      <Button variant="ghost" size="default" className="dark">Button</Button>
                      <Button variant="link" size="default" className="dark">Button</Button>
                      <Button variant="link" size="default" className="dark">Button</Button>
                      <Button variant="link" size="default" className="dark">Button</Button>
                    </div>
                    <div className="absolute top-4 right-4">
