 ...
 * @returns Hex-encoded hash string
 */
export function hashComponentData(componentData) {
 ...
 */
export async function hasFileChanged(filePath, previousHash) {
 ...
 */
export function hashComponentsData(components) {
